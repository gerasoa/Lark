  ...
  return (
    <main>
      <header className="site-header">
        ...
        <nav aria-label="Main navigation"><a href="#lessons">Lessons</a><a href="#method">How it works</a><a className="student-area-nav-link" href="/student-area">Student area</a></nav>
      ...
      <section className="lessons-section" id="lessons"><div className="shell">
        ...
        <div className="lesson-grid">
          {lessons.map((lesson)=><article className="lesson-card" key={lesson.slug}>
            <a className="lesson-card-link" href={`/lesson/${lesson.slug}`} aria-label={`Open lesson: ${lesson.title}`}>
